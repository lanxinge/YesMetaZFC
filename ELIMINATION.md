...
| 跨阶段保持原规格 | [RelationalCongruence](YesMetaZFC/Automation/RelationalCongruence.lean) 的 `openFormula_congr`、[RelationalTransfer](YesMetaZFC/Automation/RelationalTransfer.lean)、[ModelClosure](YesMetaZFC/Automation/ModelClosure.lean) | 源语法覆盖与逐符号图相等先行，避免展开整个目标解释 |
