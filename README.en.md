...
| Standard Boolean-valued ZFC model | [Boolean/ZFC](YesMetaZFC/Model/Boolean/ZFC.lean): `bv_models_zfc`, `zfc_consistent` | Constructs the full universe of small graph names for every complete Boolean algebra, verifies the original axioms and all finite-parameter schemas, and instantiates Boolean soundness to prove consistency. The construction currently uses metatheoretic choice. |
